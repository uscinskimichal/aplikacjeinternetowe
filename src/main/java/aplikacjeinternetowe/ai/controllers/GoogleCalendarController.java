...
// LOGOUT : https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://localhost:8080/login
...
public class GoogleCalendarController {
    ...
    public String exit() {
        return "https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://localhost:8080/login";
    }

    @GetMapping("/test")
    public void test(@RequestParam String user) throws IOException, GeneralSecurityException {
